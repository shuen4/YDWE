...
namespace warcraft3::japi {
    ...
    jass::jinteger_t __cdecl X_GetItemDataInteger(jass::jinteger_t typeID, jass::jinteger_t dataType) {
    ...
    jass::jboolean_t __cdecl X_SetItemDataInteger(jass::jinteger_t typeID, jass::jinteger_t dataType, jass::jinteger_t value) {
        hashtable::table<item_data_node>* table = (hashtable::table<item_data_node>*)get_item_data_table();
        if (!table) 
            return false;
    ...
    init(Item) {
        jass::japi_add((uintptr_t)X_GetItemDataInteger, "X_GetItemDataInteger",     "(II)I");
        jass::japi_add((uintptr_t)X_SetItemDataInteger, "X_SetItemDataInteger",     "(III)B");
        jass::japi_add((uintptr_t)X_GetItemColor,       "X_GetItemColor",           "(Hitem;)I");
        jass::japi_add((uintptr_t)X_SetItemColor,       "X_SetItemColor",           "(Hitem;I)B");
        jass::japi_add((uintptr_t)X_ResetItemColor,     "X_ResetItemColor",         "(Hitem;)B");
